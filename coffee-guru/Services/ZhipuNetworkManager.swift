...
class ZhipuNetworkManager {
    ...
    // 使用AppConfig中的配置
    private let apiKey = AppConfig.zhipuAPIKey
    private let baseURL = AppConfig.zhipuBaseURL
    private let flashModel = AppConfig.zhipuModel
